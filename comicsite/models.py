...
class Account(models.Model):
    ...
    followingid = models.ForeignKey('Following', models.DO_NOTHING, db_column='followingID', blank=True,
                                    null=True)  # Field name made lowercase.
...
class UserProfile(models.Model):
    ...
    followingid = models.ForeignKey('UserProfile', on_delete=models.DO_NOTHING)
